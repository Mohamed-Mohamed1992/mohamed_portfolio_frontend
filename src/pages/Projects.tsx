...
const Projects: React.FC = () => {
  const projects: Project[] = [
    {
      ...
      description: "Full-stack e-commerce platform with React, Node.js, and MongoDB. Features include user authentication, product management, and payment integration.",
    ...
    },
    {
      ...
      description: "Modern portfolio website built with React, TypeScript, and Tailwind CSS. Fully responsive with dark mode support.",
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <p className="text-gray-600 mb-8">Here are some of my recent works and personal projects</p>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.technologies.map((tech) => (
                  <span key={tech} className="bg-blue-100 text-blue-600 px-2 py-1 rounded-md text-xs">
                    {tech}
                  </span>
                ))}
              </div>
              ...
              <div className="flex space-x-4">
                <a href={project.githubLink} className="text-gray-600 hover:text-gray-900 transition-colors">
                ...
                <a href={project.liveLink} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors text-sm">
                  Live Demo
                </a>
              </div>
            </div>
